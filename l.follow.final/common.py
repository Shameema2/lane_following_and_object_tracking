...
def append_text_img1(cv2_im, objs, labels,  counter, selected_labels):
    ...
    text2 = ', '.join([f'{label}: {counter[label]}' for label in selected_labels])
    cv2_im = cv2.putText(cv2_im, text2, (width - 300, 20), font, 0.6, (0, 255, 0), 2)
